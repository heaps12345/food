...
var revealOnScroll = new _RevealOnScroll2.default((0, _jquery2.default)(".features__item"), "500", "reveal-item--is-visible");
var revealOnScroll = new _RevealOnScroll2.default((0, _jquery2.default)(".cities__item"), "300", "reveal-item--is-visible");
...
var StickyHeader = function () {
  function StickyHeader() {
    ...
    this.SectionWaypoints = (0, _jquery2.default)(".waypoint");
    this.HeaderLinks = (0, _jquery2.default)(".primary-nav a");
    this.buttonLinks = (0, _jquery2.default)(".btn__large-hero");
    this.HeaderWaypointTrigger = (0, _jquery2.default)(".features");
    this.CreateWaypoint();
      ...
      this.SectionWaypoints.each(function () {
        ...
        new Waypoint({
          ...
          handler: function handler() {
            ...
            (0, _jquery2.default)(matchingHeaderLinks).addClass("is-current-link");
          }
        });
      });
    }
...
var RevealOnScroll = function () {
  function RevealOnScroll(elements, offset, classes) {
    ...
    value: function createWaypoint() {
      ...
      this.itemsToReveal.each(function () {
        ...
        new Waypoint({
          element: currentItem,
          handler: function handler() {
            (0, _jquery2.default)(currentItem).addClass(that.classes);
          },
          offset: that.offset
        });
      });
